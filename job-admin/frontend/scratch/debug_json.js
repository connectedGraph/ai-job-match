...
// The user's JSON as a raw string (I will use a heredoc-like logic by reading it if I could, but I'll paste it)
const jsonContent = `{
...
try {
  ...
  if (pos) {
    ...
    console.log("INVALID at position", index);
    console.log("Context:", jsonContent.substring(Math.max(0, index - 20), Math.min(jsonContent.length, index + 20)));
  } else {
